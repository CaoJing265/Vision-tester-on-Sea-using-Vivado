...
HD_PWD='C:/Users/Qzzzz/Desktop/shiliyi/shiliyi/HDMI_Demo.runs/wei_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wei_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wei_rom.tcl
