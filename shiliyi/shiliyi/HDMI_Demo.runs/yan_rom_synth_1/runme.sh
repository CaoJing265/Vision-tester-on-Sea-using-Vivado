...
HD_PWD='C:/Users/Qzzzz/Desktop/shiliyi/shiliyi/HDMI_Demo.runs/yan_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log yan_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source yan_rom.tcl
