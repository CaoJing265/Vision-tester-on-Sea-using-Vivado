...
HD_PWD='C:/Users/Qzzzz/Desktop/shiliyi/shiliyi/HDMI_Demo.runs/l53_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log l53.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source l53.tcl
