...
HD_PWD='C:/Users/Qzzzz/Desktop/shiliyi/shiliyi/HDMI_Demo.runs/ku_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ku_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ku_rom.tcl
