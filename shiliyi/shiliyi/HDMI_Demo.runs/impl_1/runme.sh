...
HD_PWD='D:/SEAEnglish/example2/HDMI_Demo/HDMI_Demo/HDMI_Demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_Demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HDMI_Demo.tcl -notrace
