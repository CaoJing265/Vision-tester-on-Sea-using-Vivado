...
HD_PWD='C:/Users/Qzzzz/Desktop/shiliyi/shiliyi/HDMI_Demo.runs/xiao_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xiao_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xiao_rom.tcl
