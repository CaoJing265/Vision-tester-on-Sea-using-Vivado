...
HD_PWD='D:/SEAEnglish/example2/HDMI_Demo/HDMI_Demo/HDMI_Demo.runs/wu_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wu_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wu_rom.tcl
