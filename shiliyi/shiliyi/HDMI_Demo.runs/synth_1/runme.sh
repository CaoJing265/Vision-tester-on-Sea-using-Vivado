...
HD_PWD='D:/SEAEnglish/example2/HDMI_Demo/HDMI_Demo/HDMI_Demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_Demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_Demo.tcl
