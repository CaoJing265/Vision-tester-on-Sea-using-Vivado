...
#
# Generated by export_simulation on Wed Oct 30 21:07:30 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './wan2.sh' script.
...
./wan2.sh -noclean_files

For more information on the script, please type './wan2.sh -help'.
