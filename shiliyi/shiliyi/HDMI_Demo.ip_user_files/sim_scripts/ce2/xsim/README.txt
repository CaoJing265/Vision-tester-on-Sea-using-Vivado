...
#
# Generated by export_simulation on Wed Oct 30 23:25:27 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './ce2.sh' script.
...
./ce2.sh -noclean_files

For more information on the script, please type './ce2.sh -help'.
